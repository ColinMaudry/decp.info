...
register_page(
    ...
    title="Présentation | Le projet | colibre",
...
def layout(**_):
    contenu = html.Div(
        [
            ...
            dcc.Markdown(
                """Outil d'exploration des données de marchés publics, en [licence libre](/projet/explorer) et [100 % Open Data](/projet/donnees), développé par Colin Maudry via la société [Colmo](https://annuaire-entreprises.data.gouv.fr/entreprise/colmo-989393350).
...
permettre à un large public de mieux comprendre qui achète quoi, à qui, pour combien, etc. Si vous le trouvez utile, [envoyez un message](/projet/contact) pour exposer
vos cas d'usages et vos besoins. Cet outil ne peut rester
performant qu'avec la connaissance des problèmes à résoudre.
Ce projet est financé par ses [abonné·es](/projet/abonnement) et par des missions de conseil et de développement.
...
"""
    ...
    return projet_shell("presentation", contenu)
