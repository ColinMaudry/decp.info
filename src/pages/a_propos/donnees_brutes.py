...
register_page(
    ...
    title="Données brutes | À propos | decp.info",
    description="Téléchargez ou interrogez les données brutes qui alimentent decp.info.",
...
def layout(**_):
    contenu = html.Div(
        [
            ...
            dcc.Markdown(
                """
Vous pouvez consommer les données qui alimentent decp.info en les téléchargeant [sur data.gouv.fr](https://www.data.gouv.fr/datasets/donnees-essentielles-de-la-commande-publique-consolidees-format-tabulaire) (Parquet, CSV), pensez à lire la description du jeu de données
